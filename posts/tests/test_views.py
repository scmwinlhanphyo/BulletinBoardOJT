...
class LoginViewTest(TestCase):
    ...
    def test_login_invalid_password(self):
        res_invalid_pass = self.client.post(
            reverse("user_login"), {"email": "tester@gmail.com", "password": "wrong"})
...
class UserListViewTest(TestCase):
    ...
    def test_user_list_initial(self):
        ...
        self.assertEqual(len(response.context["page_obj"]), 1)
        self.assertEqual(
            response.context["page_obj"][0].email, "tester1@gmail.com")
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
...
#             reverse("user-profile"))
#         self.assertEqual(response.status_code, 200)
#         self.assertEqual(response.context["email"], "tester@gmail.com")
...
#         self.client.login(email="tester@gmail.com", password="12345")
#         response = self.client.post(reverse(
#             "password-reset"), {"password": "12345", "new_password": "thePass123Z", "new_password_confirm": "thePass123Z"})
#         self.assertEqual(response.status_code, 302)
#         self.assertEqual(response.url, reverse("user-list"))
...
#         self.assertEqual(response.status_code, 200)
#         self.assertTemplateUsed(
#             response, "posts/user-update.html"
#         )
